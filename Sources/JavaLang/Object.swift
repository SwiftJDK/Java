...
open class Object { 
	...
	// 
	private var shadow$_klass_: Class!
	private var shadow$_monitor_: Int32 = 0
	...
	//  package-private
	internal static func identityHashCode(_ obj: Object!) -> Int32 {
		var lockWord: Int32 = obj.shadow$_monitor_
		var lockWordStateMask: Int32 = 3221225472
		var lockWordStateHash: Int32 = 2147483648
		var lockWordHashMask: Int32 = 0xFFFFFFF
		//  Low 28 bits.
	...
	//      * is not sufficient.
	@FastNative
	private static __extern func identityHashCodeNative(_ obj: Object!) -> Int32
	...
	open func clone() -> Object! {
		if !self is Cloneable! {
			throw CloneNotSupportedException("Class " + getClass().getName() + " doesn\'t implement Cloneable")
		}
	...
	@FastNative
	private __extern func internalClone() -> Object!
	...
	//      * @see        java.lang.Object#wait()
	@FastNative
	public __extern func notifyAll()
	...
	public func wait(_ timeout: Int64) {
		wait(timeout, 0)
	}
	...
	//@FastNative
    public /* __extern */ func wait(_ timeout: Int64, _ nanos: Int32) {
